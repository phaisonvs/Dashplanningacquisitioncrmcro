...
const TokenPill = ({
  ...
  <span
    ...
    style={{
      ...
      background: `${color}10`,
      color,
      fontSize: compact ? "var(--titulo-pagina)" : "var(--titulo-secao)",
      fontWeight: 800,
    ...
    >
      ...
      >
        <motion.div
          ...
          data-ui="capa-rotulo-pagina"
          style={{
            display: "flex",
            gap: "12px",
            marginBottom: isCompact ? "20px" : "18px",
            alignItems: "center",
            flexWrap: "wrap",
          }}
        >
          <div
            data-ui="capa-rotulo-linha"
            style={{
          ...
          />
          <span
            data-ui="capa-rotulo-texto"
            style={{
              color: "rgba(255,255,255,0.42)",
              fontSize: isCompact ? "var(--paragrafo-grande)" : "var(--rotulo)",
              fontWeight: 700,
              letterSpacing: "var(--tracking-label)",
              textTransform: "uppercase",
            }}
        ...
        <motion.p
          ...
          data-ui="capa-descricao"
          style={{
            color: "rgba(255,255,255,0.5)",
            fontSize: "var(--paragrafo-grande)",
            maxWidth: isMobile ? "100%" : "540px",
            lineHeight: 1.6,
            marginTop: isCompact ? "16px" : "32px",
            fontWeight: 300,
          }}
        >
